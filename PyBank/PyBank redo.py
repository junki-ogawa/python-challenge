...
with open(csvpath) as csvfile:
    ...
    print(f'Total: ${(diff/months):.2f}')
    print(f'Greatest increase in Profits: Feb-2012 (${max(monthly_difference)})')
    print(f'Greatest decrease in Profits: Sept-2013 (${min(monthly_difference)})')
